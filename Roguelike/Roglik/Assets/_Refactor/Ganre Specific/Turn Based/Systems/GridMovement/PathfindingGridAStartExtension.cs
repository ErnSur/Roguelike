...
namespace LDF.Systems.GridMovement
{
    public static class PathfindingGridAStartExtension
    {
        ...
        public static List<PFNode> FindPath(this PathfindingGrid grid, Vector3 startingCell, Vector3 targetCell)
        {
            ...
            var startNode = grid.NodeFromWorldPoint(startingCell);
            var targetNode = grid.NodeFromWorldPoint(targetCell);
            ...
            while (_openSet.Count > 0)
            {
                ...
                foreach (var neighbour in _grid.GetNeighbours(winnerNode))
                {
                    ...
                    int newCostToNeighbour =
                        winnerNode.GCost + 1; //or winnerNode.gCost +1; GetDistance(winnerNode, neighbour)
