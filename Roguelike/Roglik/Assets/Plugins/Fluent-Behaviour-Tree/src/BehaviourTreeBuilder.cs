...
namespace FluentBehaviourTree
{
    ...
    public class BehaviourTreeBuilder
    {
        ...
        public BehaviourTreeBuilder Do(Func<TimeData, BehaviourTreeStatus> fn) => Do("", fn);
        public BehaviourTreeBuilder If(Func<TimeData, bool> fn) => If("", fn);
        public BehaviourTreeBuilder IfNot(Func<TimeData, bool> fn) => IfNot("", fn);
        ...
        public BehaviourTreeBuilder If(string name, Func<TimeData, bool> fn)
        {
            return Do(name, t => fn(t) ? BehaviourTreeStatus.Success : BehaviourTreeStatus.Failure);
        }

        public BehaviourTreeBuilder IfNot(string name, Func<TimeData, bool> fn)
        {
            return Do(name, t => fn(t) ? BehaviourTreeStatus.Failure : BehaviourTreeStatus.Success);
        }
